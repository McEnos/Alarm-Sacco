...
<?php include 'layouts/admin_navigation.php' ;?>  
    ...
    <header id="admin_header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><i class="fa fa-cog fa-spin fa-fw"></i> Alarm Sacco Admin Dashboard</h1>
          </div>
          <div class="col-md-2">
            <div class="create">
          ...
          <div class="col-md-3">
            <div class="list-group">
              <a href="" class="list-group-item active main-color-bg">
                ...
                <!-- <a href="addshipment.php" class="list-group-item"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Return Suspended  member <span class="badge">0</span></a> -->
                <?php
              ...
              <a href="manage_loan.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> List Loan Applications <span class="badge"><?php echo $loan;?></span></a>
                <?php
                $total_expence = mysqli_query($conn,"SELECT cost FROM expence") or die(mysqli_error($conn));
                $amount = 0;
                while($cost = mysqli_fetch_assoc($total_expence))
                {
                  $amount += $cost['cost'];
                }
                
                ?>
              <a href="manage_expences.php" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Sacco Expences <span class="badge"><?php echo $amount;?></span></a>
            </div>
   ...
   <div class=col-md-3>
              ...
              <a href="#" class="list-group-item"><span class="glyphicon glyphicon-" aria-hidden="true"></span> Project Profit <span class="badge">0</span></a>
              <?php
              
                $query_loan_profit = mysqli_query($conn,"SELECT amount_borrowed FROM loans WHERE amount_remaining= '0'") or die(mysqli_error($conn));
                $total_amount = 0;
                while($row = mysqli_fetch_assoc($query_loan_profit))
                {
                  $total_amount += $row['amount_borrowed'];
                }


              ?>
              <a href="#" class="list-group-item"><span class="glyphicon glyphicon-" aria-hidden="true"></span> Loan Profit <span class="badge"><?php echo $total_amount;?></span></a>
              <a href="#" class="list-group-item"><span class="glyphicon glyphicon-" aria-hidden="true"></span> Total Profit <span class="badge">0</span></a>
